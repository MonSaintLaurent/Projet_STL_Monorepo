            ...
            <div className="login-page">
                <div className="login-container">
                    ...
                    <div className="social-buttons">
                        <Button color="primary" variant="flat" size="lg" className="w-full" onPress={() => loginWithRedirect()}>🌐 Google</Button>
                        <Button color="secondary" variant="flat" size="lg" className="w-full" onPress={() => loginWithRedirect()}>🔐 Avec votre SSO</Button>
                    </div>

                    <div className="signup-section">
                        <p className="signup-text">Vous n'avez pas de compte ?</p>
                        <Button color="primary" variant="light" size="md" className="w-full" onPress={() => loginWithRedirect()}>Inscrivez-vous</Button>
                    </div>
                </div>
            </div>
        </DefaultLayout>
